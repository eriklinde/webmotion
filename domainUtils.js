var domainUtils = (function() {
    ...
    utils.extractFullDomainFromURL = function(url) {
    ...
    utils.extractRootDomainFromURL = function(url) {
        var fullDomain = utils.extractFullDomainFromURL(url);
        if (fullDomain == null) {
            return null;
        }
        else {
            ...
            if (utils.twoLevelTLDs.containsString(lastTwoSegments)) {
                nbrSegmentsNeeded = 3;
            }
